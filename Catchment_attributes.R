...
# Basins to simulate
basin_shp  <- st_read("GIS South/Basins_Patagonia_all.shp")
...
# glacier cover (RGI7)
glaciers  <- vect("GIS South/Glaciers/RGI7.shp")
...
pp_stack <- rast("Data/Precipitation/PP_PMETsim_1980_2020_v10m.nc")
...
t2m_stack <- rast("Data/Temperature/Tavg_PMETsim_1980_2020_v10d.nc")
...
writeVector(vect(basin_shp), "GIS South/Basins_Patagonia_all_data.shp", overwrite=TRUE)
write.csv(st_drop_geometry(basin_shp), "MS3 Results/Attributes_all_basins.csv")
